...
const ObjectDetailsScreen = () => {
  ...
  // more reviews
  const descriptionText = route.params?.descriptionText || "";
  ...
  return (
    ...
    >
      <View style={{ position: "relative", height: 250 }}>
        <CarouselImage images={route.params?.img} />
      ...
      >
        <CustomText style={{ fontSize: 25, fontWeight: 500, flexWrap: "wrap" }}>
          {route.params?.title || "Нет названия"}
        </CustomText>
          ...
          <View>
            ...
            >
              ...
              >
                ...
                >
                  <Text style={{ fontSize: 16 }}>Гости:</Text>
                  <CustomText style={{ fontSize: 16, fontWeight: 500 }}>
                    {route.params?.peopleQuantity || "Нет гостей"}
                  </CustomText>
                </View>
              </View>
              <View
              ...
              >
                ...
                >
                  <Text style={{ fontSize: 16 }}>Комнаты:</Text>
                  <CustomText style={{ fontSize: 16, fontWeight: 500 }}>
                    {route.params?.roomsQuantity || "Нет комнат"}
                  </CustomText>
                </View>
              </View>
            ...
            >
              ...
              <CustomText style={{ fontSize: 20, color: "#b8b8b8" }}>
                {route.params?.rating || "Нет рейтингов"}
              </CustomText>
            </View>
          </View>
          <View>
            ...
            <CustomText style={{ fontSize: 18, fontWeight: 500 }}>
              {route.params?.discountPrice || "Нет цены"} с
            </CustomText>
          </View>
        </View>
