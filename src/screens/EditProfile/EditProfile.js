...
const EditProfile = () => {
  ...
  console.log("fddf", internationalSelfie);
        ...
        >
          <View>
            ...
            <View style={{ marginBottom: 20 }}>
              <Text style={{ marginBottom: 15, fontSize: 25 }}>
              ...
              >
                ...
                <View>
                  <Text style={{ marginBottom: 10 }}>Описание</Text>
                  <Controller
                    control={control}
                    render={({ field: { onChange, value } }) => (
                      <TextInput
            ...
            {passportType === "ID" ? (
              <View>
                ...
                <View>
                  <Text style={{ marginBottom: 10 }}>Селфи с паспортом</Text>
                  <TouchableOpacity
