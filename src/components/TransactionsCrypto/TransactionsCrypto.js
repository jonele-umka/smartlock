  ...
  return (
    ...
    >
      {Object.keys(groupedTransactions).map((date) => (
        <View key={date}>
          <Text style={{ color: "#fff", marginBottom: 10, textAlign: "right" }}>
            {date}
          </Text>
          <View
            style={{
          ...
          >
            {groupedTransactions[date].map((transactions, index, array) => (
              <TouchableOpacity
                    ...
                    >
                      ...
                      >
                        {transactions.ReceiverRequisites.length > 16
                          ? transactions.ReceiverRequisites.substring(0, 16) +
                            "..."
                          : incoming.includes(transactions)
                          ? transactions.ReceiverRequisites.slice(-4).padStart(
